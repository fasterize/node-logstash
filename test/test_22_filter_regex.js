...
vows.describe('Filter regex ').addBatch({
  ...
  'date parsing with output date format': filter_helper.create('regex', '?regex=^(.*)$&fields=timestamp&date_format=DD/MMMM/YYYY:HH:mm:ss.SSS ZZ&output_date_format=YYYY-MM-DDTHH:mm:ss.SSSZ', [
    ...
    {'@message': '31/Jul/2012:18:02:28.123 +0200', '@fields': {}, '@timestamp': '2012-07-31T16:02:28.123+00:00'},
    {'@message': '31/Jul/2012', '@fields': {}, '@timestamp': '2012-07-31T00:00:00.000+00:00'},
    {'@message': 'toto', '@fields': {}},
  ]),
